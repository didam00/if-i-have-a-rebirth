(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function e(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=e(i);fetch(i.href,o)}})();class b extends EventTarget{constructor(){super(),this.countries=[],this.isLoading=!0,this.error=null,this._dataPromise=null}static get instance(){return b._instance||(b._instance=new b),b._instance}loadData(){return this._dataPromise||(this._dataPromise=fetch("/if-i-have-a-rebirth/data/population.json").then(t=>{if(!t.ok)throw new Error(`HTTP 오류! 상태: ${t.status}`);return t.json()}).then(t=>this.countries=Object.freeze(t)).catch(t=>this.error=t.message).finally(()=>{this.isLoading=!1,this.dispatchEvent(new CustomEvent("updated"))})),this._dataPromise}}const E=b.instance;/**
 * @license
