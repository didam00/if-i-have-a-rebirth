(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function e(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=e(i);fetch(i.href,o)}})();class b extends EventTarget{constructor(){super(),this.countries=[],this.isLoading=!0,this.error=null,this._dataPromise=null}static get instance(){return b._instance||(b._instance=new b),b._instance}loadData(){return this._dataPromise||(this._dataPromise=fetch("/data/population.json").then(t=>{if(!t.ok)throw new Error(`HTTP 오류! 상태: ${t.status}`);return t.json()}).then(t=>this.countries=Object.freeze(t)).catch(t=>this.error=t.message).finally(()=>{this.isLoading=!1,this.dispatchEvent(new CustomEvent("updated"))})),console.log("check"),this._dataPromise}}const E=b.instance;/**
 * @license
 ...
 */function v(r){return pt({...r,state:!0,attribute:!1})}var kt=Object.defineProperty,It=Object.getOwnPropertyDescriptor,x=(r,t,e,s)=>{for(var i=s>1?void 0:s?It(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(t,e,i):n(i))||i);return s&&i&&kt(t,e,i),i};let m=class extends w{constructor(){super(...arguments),this.country={name:"대한민국",population:51207874,percentage:.59,year:2025,code:"kr"},this.countryName="대한민국",this.countryPercentage=.59,this.imageUrl="https://flagcdn.com/w640/kr.jpg",this.isLoading=!1}render(){return lt`
    ...
    `}async connectedCallback(){super.connectedCallback(),await E.loadData()}firstUpdated(){this.addEventListener("country-selected",r=>{const{country:t}=r.detail;this.country=t,this.isLoading=!0;const e=new Image;e.src=`https://flagcdn.com/w320/${t.code}.jpg`;const s=750,i=250,o=setInterval(async()=>{await E.loadData();const h=E.countries,a=h[Math.floor(Math.random()*h.length)];this.countryName=a.name,this.countryPercentage=a.percentage},50),n=this.shadowRoot?.querySelector(".flag-image");n&&(n.animate([{opacity:1},{opacity:0}],{duration:s,easing:"ease-out"}),setTimeout(()=>{this.imageUrl=e.src,n.animate([{opacity:0},{opacity:1}],{duration:i,easing:"ease-out"})},s),setTimeout(()=>{this.isLoading=!1,clearInterval(o),this.countryName=this.country?.name||"",this.countryPercentage=this.country?.percentage||0},s+i))})}};m.styles=[nt`
      h1 {
